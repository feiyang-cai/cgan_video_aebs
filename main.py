...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='dummy', help='Name of the dataset')
    ...
    parser.add_argument('--num_rnn_layers', type=int, default=1, help='Number of layers in RNN')
    ...
    parser.add_argument('--num_D_steps', type=int, default=1, help='Number of steps to train discriminator')
    parser.add_argument('--condition_lambda', type=float, default=10.0, help='Lambda for conditioning loss')
    parser.add_argument('--output_dir', type=str, default='outputs', help='Output directory')
    parser.add_argument('--log_frequency', type=int, default=1, help='Log frequency')
    parser.add_argument('--visualize_frequency', type=int, default=10, help='Visualize frequency')
